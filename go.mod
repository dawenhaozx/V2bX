...
require (
	...
	github.com/sagernet/sing-tun v0.4.0-beta.4 // indirect
...
replace github.com/sagernet/sing-box v1.9.0 => github.com/dawenhaozx/sing-box v1.8.12-0.20240531080624-64c1d3d6c6e2
